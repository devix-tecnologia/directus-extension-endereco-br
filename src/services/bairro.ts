...
export class BairroService {
    ...
    bairroService: ItemsService<Bairro>;
    cidadeService: ItemsService<Cidade>;
    estadoService: ItemsService<Estado>;
    ...
    obterIdBairroPorEndereco(bairro: string, cidade: string, estado: string, bairros: Bairro[]) {
        const [bairroLimpo, cidadeLimpa, estadoLimpo] = [bairro, cidade, estado].map(this.lowerCaseSemAcentos);
