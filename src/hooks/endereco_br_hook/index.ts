...
import { AbstractServiceOptions, ApiExtensionContext } from '../../types/DirectusImports.js';
import { atualizarCoordenadasEndereco, processaPesquisaCep } from '../../utils/hook.js';
import { Endereco } from '../../utils/types.js';

const enderecoBrHook: ReturnType<typeof defineHook> = defineHook(
	({ filter, action }, apiExtensionContext) => {
		...
		const getEnderecoService = (
			...
			const enderecoService = new apiExtensionContext.services.ItemsService('endereco_br', opts);
